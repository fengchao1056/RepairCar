...
//        wxapi = WXAPIFactory.createWXAPI(CommApplication.getContext(), appID, true);
...
//        if (wxapi == null)
//            wxapi = WXAPIFactory.createWXAPI(CommApplication.getContext(), appID);
//        if (wxapi.isWXAppInstalled()) {
//            return true;
//        } else {
//            Toast.makeText(CommApplication.getContext(),"暂未安装微信", Toast.LENGTH_SHORT).show();
//            return false;
//        }
//    }
//
...
//        Bitmap bmp = BitmapFactory.decodeResource(CommApplication.getContext().getResources(), R.mipmap.ic_launcher);
