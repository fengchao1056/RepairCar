...
//	private Context context;
	...
	public static WXUserInfo getWXUserInfo(Context context, String key) {
		if (sp == null)
			sp = context.getSharedPreferences(SP_NAME, 0);
		String string = sp.getString(key, "");

		return new Gson().fromJson(string,WXUserInfo.class);
	}
	public static void saveWXUserInfo(Context context, String key, WXUserInfo  bean) {
		if (sp == null)
			sp = context.getSharedPreferences(SP_NAME, 0);
		sp.edit().putString(key, new Gson().toJson(bean)).commit();
	}
