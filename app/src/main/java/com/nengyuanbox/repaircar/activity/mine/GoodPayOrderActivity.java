...
import com.nengyuanbox.repaircar.fragment.NoPaymentFragment;
...
//订单界面
public class GoodPayOrderActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getFragment() {
        NoPaymentFragment toProcessedFragment=new NoPaymentFragment();
...
//            返回
            case R.id.iv_back:
//                startActivity(new Intent(GoodPayOrderActivity.this, MainActivity.class));
                finish();
                break;
