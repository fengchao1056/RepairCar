...
//  师傅认证付款界面
public class MastPaymentActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_mast_payment;
    }
    ...
    private void getWxPay() {
        ...
        netUtils.putReturnJsonNews(context, NetUtils.POST, UrlConstant.GETWXPAY, jsonObject, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if ("2000".equals(response.getString("code"))) {
                        ...
                        LoginExpirelUtils.getLoginExpirel(MastPaymentActivity.this);
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                CommonDialog.showInfoDialog(MastPaymentActivity.this, getResources().getString(R.string.net_error));
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if ("2000".equals(response.getString("code"))) {
                        ...
                        Toast.makeText(MastPaymentActivity.this, "微信支付", Toast.LENGTH_SHORT).show();
                    } else if (Double.parseDouble(response.getString("code")) > 3000) {
                        LoginExpirelUtils.getLoginExpirel(MastPaymentActivity.this);
...
//    微信支付成功回调
    ...
    private void showdialog( final String string) {
        final DialogSure rxDialogSure = new DialogSure(MastPaymentActivity.this);//提示弹窗
        ...
        rxDialogSure.getSureView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (string.equals("支付成功！")) {
                    Intent intent = new Intent(MastPaymentActivity.this, MasterCardCertificationActivity.class);
