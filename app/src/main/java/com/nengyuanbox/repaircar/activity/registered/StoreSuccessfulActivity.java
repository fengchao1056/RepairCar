...
//  门店认证成功界面
public class StoreSuccessfulActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_store_successful;
    }

    @Override
    protected void initView() {
        //将应用的appid注册到微信
        api = WXAPIFactory.createWXAPI(StoreSuccessfulActivity.this, Constant.APP_ID_WX, true);
        //将应用的appid注册到微信
        api.registerApp(Constant.APP_ID_WX);
        GETQRCODEIMG();
        openid = SharedPreferenceUtil.getString(StoreSuccessfulActivity.this,Constant.OPENID,"");

//        SharedPreferenceUtil.saveString(StoreSuccessfulActivity.this, Constant.ROLE, "store");
...
//            1、推广码 2、评价码
        ...
        netUtils.putReturnJsonNews(context, NetUtils.POST, UrlConstant.GETQRCODEIMG, jsonObject, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if ("2000".equals(response.getString("code"))) {
                        ...
                        Glide.with(StoreSuccessfulActivity.this)
                                .load(img_url)
                        ...
                        LoginExpirelUtils.getLoginExpirel(StoreSuccessfulActivity.this);
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                CommonDialog.showInfoDialog(StoreSuccessfulActivity.this, getResources().getString(R.string.net_error));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_back:
                startActivity(new Intent(StoreSuccessfulActivity.this,MineActivity.class));
                finish();
                break;
            case R.id.tv_share:
