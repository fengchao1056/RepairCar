...
public class FullDetailsFragment extends BaseFragment {
    ...
    private class MyHandler extends Handler {
        ...
        private final WeakReference<FullDetailsFragment> mActivity;
        private FullDetailsFragment activity;

        private MyHandler(FullDetailsFragment activity) {

            mActivity = new WeakReference<FullDetailsFragment>(activity);
        ...
        NetUtils.newInstance().putReturnJsonNews(getActivity(), NetUtils.POST, UrlConstant.GETUSERFLOW, jsonObject, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    ViseLog.d("全部-资金流水记录" + response.toString());
                    ...
                    if ("2000".equals(response.getString("code"))) {
                        ...
                        if (data != null && data.size() > 0) {
                            list.addAll(data);
//                            getUserFlowAdapter.addData(data);
                    ...
                    ViseLog.d("全部-资金流水记录baocuo" + e.toString());
                    e.printStackTrace();
                }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                CommonDialog.closeProgressDialog();
                ViseLog.d("全部-资金流水记录baocuo" + throwable.toString() + responseString);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                CommonDialog.closeProgressDialog();
                ViseLog.d("全部-资金流水记录baocuo2" + throwable.toString());
                CommonDialog.showInfoDialog(getActivity(), getResources().getString(R.string.net_error));
            }
