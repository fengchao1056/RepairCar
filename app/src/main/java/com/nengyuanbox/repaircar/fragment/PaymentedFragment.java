...
//已支付列表
public class PaymentedFragment extends BaseFragment {
    ...
    private class MyHandler extends Handler {
        ...
        private final WeakReference<PaymentedFragment> mActivity;
        private PaymentedFragment activity;

        private MyHandler(PaymentedFragment activity) {

            mActivity = new WeakReference<PaymentedFragment>(activity);
