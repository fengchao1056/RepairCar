...
public class ExpenditureFragment extends BaseFragment {
    ...
    private class MyHandler extends Handler {
        ...
        private final WeakReference<ExpenditureFragment> mActivity;
        private ExpenditureFragment activity;

        private MyHandler(ExpenditureFragment activity) {

            mActivity = new WeakReference<ExpenditureFragment>(activity);
        ...
        NetUtils.newInstance().putReturnJsonNews(getActivity(), NetUtils.POST, UrlConstant.GETUSERFLOW, jsonObject, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    ViseLog.d("支出账户明细" + response.toString());
                    ...
                    ViseLog.d("支出账户明细baocuo" + e.toString());
                    e.printStackTrace();
                }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                CommonDialog.closeProgressDialog();
                ViseLog.d("支出账户明细baocuo" + throwable.toString() + responseString);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                CommonDialog.closeProgressDialog();
                ViseLog.d("支出账户明细baocuo2" + throwable.toString());
                CommonDialog.showInfoDialog(getActivity(), getResources().getString(R.string.net_error));
            }
