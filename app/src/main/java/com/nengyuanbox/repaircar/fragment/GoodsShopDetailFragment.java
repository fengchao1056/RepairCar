...
//购买须知
public class GoodsShopDetailFragment extends BaseFragment {
...
//        RxToast.normal("GraphicDetailsFragment");
    ...
    @Subscribe
     public  void  getGoodsDetailsEvent(GoodsDetailEventBean eventBean){
          if (!RxDataTool.isEmpty(eventBean.getGoods_shop_detail())){
              ViseLog.d("图文详情："+eventBean.getGoods_shop_detail());
              wv_view.loadDataWithBaseURL(null,
                      getHtmlData(eventBean.getGoods_shop_detail()), "text/html", "utf-8", null);
          }
