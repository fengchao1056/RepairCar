...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
        ...
        AndPermission.with(this)
                ...
                .onDenied(new Action() {
                    ...
                    public void onAction(List<String> permissions) {
                        ...
                        Toast.makeText(CaptureActivity.this, "没有权限无法扫描呦", Toast.LENGTH_LONG).show();
                    }
                }).start();
    }
    ...
    private void initView() {
        ...
        switchVisibility(flashLightLayout, false);
    ...
    private void getgroup() {
        ...
        rg_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                int position = rg_group.getCheckedRadioButtonId();
                RadioButton btn = (RadioButton) findViewById(position);
                btn.setChecked(true);
                String info = btn.getText().toString();
                if (info.equals("手动录入")){
                    Intent intent = getIntent();
                    intent.putExtra(Constant.CODED_CONTENT, "手动录入");
                    setResult(RESULT_OK, intent);
//                    startActivity(new Intent(CaptureActivity.this,ApplySaleActivity.class));
                    finish();
                }else if (info.equals("相册")){
                ...
                }else if (info.equals("扫码枪")){

                    Intent intent = getIntent();
                    intent.putExtra(Constant.CODED_CONTENT, "扫码枪");
                    setResult(RESULT_OK, intent);
//                    startActivity(new Intent(CaptureActivity.this,BarcodeScannerActivity.class));
                    finish();
